...
public class OptionSet {
	...
	public java.util.ArrayList getOptionData() {
		return options;
	}
	...
	public OptionData getOption(String key) {
		...
		return (OptionData) keys.get(key);
	}
	...
	public boolean isSet(String key) {
		...
		return ((OptionData) keys.get(key)).getResultCount() > 0 ? true : false;
	}
	...
	public java.util.ArrayList getUnmatched() {
		return unmatched;
	}
