...
//		System.out.println();
                System.arraycopy(B_new.getColumn(0), 0, B, 0, B_new.getColumn(0).length);
	}
	...
	public static void main(String[] args) {
		...
		double[][] X = { { 1, 15, 4 }, { 1, 30, 14 }, { 1, 31, 16 }, { 1, 31, 11 }, { 1, 32, 17 }, { 1, 29, 10 },
                ...
                LogisticRegression LogReg = null;
		for(int i = 0; i < 10; i++) {
			LogReg = new LogisticRegression(Y, X, false);
			LogReg.MLE();
		}
		double[] res = LogReg.getResiduals1();
