...
public class LandscapeHistogram extends AbstractChart implements SelectionListener {
	...
	protected void selectionChanged(Rectangle2D before, Rectangle2D after, boolean done) {
		if (zoom1d) {
			...
			super.selectionChanged(before == null ? null : new Rectangle2D.Double(before.getMinX(), ymin, before.getWidth(), ymax - ymin),
					new Rectangle2D.Double(after.getMinX(), ymin, after.getWidth(), ymax - ymin), done);
		} else {
