...
/**
 * Runnable that invokes another runnable on the swing event queue thread. Uses
 * <code>SwingUtilities.invokeLater()</code> or
 * <code>SwingUtilities.invokeAndWait()</code>, depending on which mode of
...
public class SwingInvoker implements Runnable {
	...
	/**
	 * Indicates whether the target will be invoked synchronously (true), or
	 * asynchronously (false).
	 */
	private final boolean wait;

	/**
	 * Construct a <code>SwingInvoker</code> that invokes the target
	 * asynchronously.
	 * 
	 * @param target
	 *            Runnable to be invoked
	 */
	public SwingInvoker(Runnable target) {
		this(target, false);
	}

	/**
	 * Construct a <code>SwingInvoker</code> that invokes the target either
	 * synchronously or asynchronously, depending on the value of the
	 ...
	 */
	public SwingInvoker(Runnable target, boolean wait) {
		this.target = target;
		this.wait = wait;
	}
