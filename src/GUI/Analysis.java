...
//	private  JPanel panel_1 = new JPanel();
	...
	private final JSplitPane spnlSummary = new JSplitPane();
	private final JPanel pnlSummary = new JPanel();
	private final Component horizontalGlue_1 = Box.createHorizontalGlue();
	private final Component horizontalStrut_1 = Box.createHorizontalStrut(150);
	private final Component horizontalGlue_2 = Box.createHorizontalGlue();
	private final Component horizontalStrut_2 = Box.createHorizontalStrut(60);
	private final Component horizontalGlue_3 = Box.createHorizontalGlue();
	private final Component horizontalGlue_4 = Box.createHorizontalGlue();
	private final Component horizontalGlue_5 = Box.createHorizontalGlue();
	private final Component horizontalGlue_6 = Box.createHorizontalGlue();
	private final Component horizontalStrut_3 = Box.createHorizontalStrut(85);
	private final Component horizontalGlue_7 = Box.createHorizontalGlue();
	private final Component horizontalGlue_8 = Box.createHorizontalGlue();
	private final Component horizontalStrut_4 = Box.createHorizontalStrut(80);
	private final JPanel pnlAnalysis = new JPanel();
...
//			runanalysis.setForeground(cmdLoadDatafile.getForeground());
	...
	public Analysis()
	{
		...
		tabbed.addTab("MDR Analysis", null, pnlAnalysis, null);
		pnlAnalysis.setLayout(new GridLayout(0, 1, 0, 0));
		splitPane.setResizeWeight(0.7);
	
		splitPane.setOrientation(JSplitPane.VERTICAL_SPLIT);
		pnlAnalysis.add(splitPane);
		pnlSummary.setLayout(new GridLayout(0, 1, 0, 0));
	...
	public void initAnalysis()
	{
		...
		pnlline1.add(horizontalGlue_1);
		pnlline1.add(seed);
		seed.setText("0");
		
		pnlline1.add(horizontalStrut_1);
		pnlline1.add(label1112);
		
		pnlline1.add(horizontalGlue_4);
		pnlline1.add(ispaired);
		
		pnlline1.add(horizontalStrut_4);
		pnlline1.add(label1113);
		
		pnlline1.add(horizontalGlue_5);
		...
		pnlline2.add(horizontalGlue_2);
		pnlline2.add(mincount);
		mincount.setText("1");
		pnlline2.add(maxcount);
		maxcount.setText("3");
		
		pnlline2.add(horizontalStrut_2);
		pnlline2.add(label1122);
		
		pnlline2.add(horizontalGlue_3);
		
		pnlline2.add(horizontalGlue_6);
		pnlline2.add(tie);
		...
		pnlline3.add(horizontalGlue_7);
		pnlline3.add(cv);
		cv.setText("10");
		
		pnlline3.add(horizontalStrut_3);
		pnlline3.add(label1132);
		
		pnlline3.add(horizontalGlue_8);
		...
		pnlsearchconfig.setPreferredSize(new Dimension(785, 40));
		...
		pnlanalysiscontrol.setPreferredSize(new Dimension(785, 30));
		pnlanalysiscontrol.setBorder(BorderFactory.createTitledBorder("Analysis Controls"));
		jpanalysis.add(pnlanalysiscontrol);
		prgProgress.setPreferredSize(new Dimension(785, 15));
		jpanalysis.add(prgProgress);
		prgProgress.setLayout(new GridLayout(1, 0, 0, 0));
		pnlSummary.setPreferredSize(new Dimension(785, 250));
		pnlSummary.add(spnlSummary);
		spnlSummary.setOrientation(JSplitPane.VERTICAL_SPLIT);
...
//		jpanalysis.add(panel_1);
		...
		spnlSummary.setLeftComponent(jpsummary);
		spnlSummary.setRightComponent(tpnResults);
		...
		splitPane.setLeftComponent(jpanalysis);
	    splitPane.setRightComponent(pnlSummary);
	    jpanalysis.setMaximumSize(new Dimension(485, 430));
	    jpanalysis.setMinimumSize(new Dimension(485,30));
	    pnlSummary.setMaximumSize(new Dimension(485, 430));
	    pnlSummary.setMinimumSize(new Dimension(485,30));
	}
			...
			try {
				...
				if (line != null && line.contains("Scorefile = ")) {
					...
					if (phenofile.exists()) {
						...
						pnlselectedresidual.removeAll();
						txtscorefile.setText("");
						txtscorefile.setBackground(UIManager.getColor("Color.WHITE"));
						removeresponse.setEnabled(true);
						addresponse.setEnabled(true);
						removepredictor.setEnabled(true);
						addpredictor.setEnabled(true);
...
//				cmdExportFiltered.setEnabled(true);
	...
	//	pnlphepath.setSize(700, 10);
		...
		Comblinkfunc.setMaximumRowCount(10);
		panel_3.add(Comblinkfunc);
		Comblinkfunc.setPreferredSize(new Dimension(230, 20));
		...
		label242.setFont(new Font("SimSun", Font.PLAIN, 12));
		...
		combestimatemethod.setMaximumRowCount(10);
		combestimatemethod.setPreferredSize(new Dimension(230, 20));
		...
		pnlresidual_path.setPreferredSize(new Dimension(550, 20));
	...
	class JTextArea_loadpheno_actionAdapter implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) {
			// TODO Auto-generated method stub
			String fileaddress=cmdJTextArea_actionPerforme(adapter.txtphenopath);
			if(fileaddress!=null)
				cmdLoadphenotype_actionPerformed(fileaddress);
			adapter.repaint();
		}
	...
	class JTextArea_loadScore_actionAdapter implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) {
			// TODO Auto-generated method stub
			String fileaddress=cmdJTextArea_actionPerforme(adapter.txtscorefile);
			if(fileaddress!=null)
				cmdLoadScore_actionPerformed(fileaddress);
			adapter.repaint();
		}
		
	}
	
	private String cmdJTextArea_actionPerforme(JTextField txtphenopath) 
	{
		String fileaddress=txtphenopath.getText();
